...
class BizniWebExporter:
    ...
    def add_reporting_product_identity_columns(self, df: pd.DataFrame) -> pd.DataFrame:
        """Prepare project-scoped canonical product keys for all downstream reporting analyses."""
    ...
    def _resolve_product_expense(
        ...
        identifier_candidates = [
            warehouse_number_candidate,
            import_code_candidate,
            product_sku_candidate,
        ]
        exact_compound_candidates = [
            self._compose_expense_key(title_candidate, warehouse_number_candidate),
            self._compose_expense_key(title_candidate, import_code_candidate),
            self._compose_expense_key(title_candidate, product_sku_candidate),
        ]
        exact_candidates = (
            [*exact_compound_candidates, title_candidate, *identifier_candidates]
            if EXPENSE_MATCH_MODE == "title_first"
            else [*exact_compound_candidates, *identifier_candidates, title_candidate]
        )
        ...
        normalized_candidates = (
            [*normalized_compound_candidates, normalized_title_candidate, *normalized_identifier_candidates]
            if EXPENSE_MATCH_MODE == "title_first"
            else [*normalized_compound_candidates, *normalized_identifier_candidates, normalized_title_candidate]
        )
    ...
    def analyze_day_of_week(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        orders_per_day['profit'] = orders_per_day['profit_without_fixed']
    ...
    def analyze_week_of_month(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        wom_orders_agg['profit'] = wom_orders_agg['profit_without_fixed']
    ...
    def analyze_day_of_month(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        dom_orders_agg['profit'] = dom_orders_agg['profit_without_fixed']
    ...
    def analyze_weather_impact(
        ...
        analysis_df["profit"] = analysis_df["profit_without_fixed"]
        ...
        valid["profit_vs_weekday_baseline"] = valid["profit_without_fixed_vs_weekday_baseline"]
        ...
        bucket_summary["avg_daily_profit"] = bucket_summary["avg_daily_profit_without_fixed"]
        bucket_summary["profit_vs_weekday_baseline"] = bucket_summary["profit_without_fixed_vs_weekday_baseline"]
        ...
        bucket_summary["profit_uplift_pct"] = bucket_summary["profit_without_fixed_uplift_pct"]
        ...
        correlations["rain_profit"] = correlations["rain_profit_without_fixed"]
        correlations["temp_profit"] = correlations["temp_profit_without_fixed"]
        correlations["bad_score_profit"] = correlations["bad_score_profit_without_fixed"]
        ...
        for lag in (0, 1, 2):
            ...
            lag_correlations[f"lag_{lag}_day"]["profit"] = lag_correlations[f"lag_{lag}_day"]["profit_without_fixed"]
    ...
    def analyze_geographic(self, df: pd.DataFrame) -> tuple:
        ...
        country_agg['profit'] = country_agg['profit_without_fixed']
        ...
        city_agg['profit'] = city_agg['profit_without_fixed']
    ...
    def analyze_geo_profitability(self, df: pd.DataFrame, fb_campaigns: list = None) -> dict:
        ...
        geo['contribution_cost'] = geo['contribution_cost_without_fixed']
        geo['contribution_profit'] = geo['contribution_profit_without_fixed']
        geo['contribution_margin_pct'] = geo['contribution_margin_without_fixed_pct']
    ...
    def analyze_b2b_vs_b2c(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        b2b_agg['profit'] = b2b_agg['profit_without_fixed']
    ...
    def analyze_product_margins(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        product_margins['profit'] = product_margins['profit_without_fixed']
    ...
    def analyze_customer_concentration(self, df: pd.DataFrame) -> dict:
        ...
        customer_revenue['profit'] = customer_revenue['profit_without_fixed']
