...
DEFINITION_HEAD_ALIASES = {
    ...
    "sambre": "chambray",
    "chambray": "chambray",
    "herringbone": "rybia kost",
    "herringbone fabric": "rybia kost",
    "herringbone weave": "rybia kost",
    "rybia kost": "rybia kost",
    "loden": "loden varena vlna plst",
    "loden a varena vlna": "loden varena vlna plst",
    "loden fabric": "loden varena vlna plst",
    "boiled wool": "loden varena vlna plst",
    "boiled wool fabric": "loden varena vlna plst",
    "varena vlna": "loden varena vlna plst",
    "plst": "loden varena vlna plst",
    "taffeta": "taft",
    "tafeta": "taft",
    "taft": "taft",
    "voal": "voal",
    "voal na zaclony": "voal",
    ...
    "pepito": "pepito kohutia stopa a glen check",
    "kohutia stopa": "pepito kohutia stopa a glen check",
    "houndstooth": "pepito kohutia stopa a glen check",
    "houndstooth fabric": "pepito kohutia stopa a glen check",
    "dogtooth": "pepito kohutia stopa a glen check",
    "glen check": "pepito kohutia stopa a glen check",
    "glen plaid": "pepito kohutia stopa a glen check",
    "prince of wales check": "pepito kohutia stopa a glen check",
    "shepherd s check": "pepito kohutia stopa a glen check",
    "pepito kohutia stopa a glen check": "pepito kohutia stopa a glen check",
    "barchet": "barchet a fustian",
    "barchent": "barchet a fustian",
    "flannelette": "barchet a fustian",
    "flanelet": "barchet a fustian",
    "fustian": "barchet a fustian",
    "barchet a fustian": "barchet a fustian",
    "dobby": "dobby tkanina",
    "dobby cloth": "dobby tkanina",
    "dobby fabric": "dobby tkanina",
    "dobby tkanina": "dobby tkanina",
    "dobby weave": "dobby tkanina",
    "moire": "moare",
    "moire antique": "moare",
    "watered silk": "moare",
    "moare": "moare",
