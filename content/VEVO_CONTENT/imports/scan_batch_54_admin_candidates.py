#!/usr/bin/env python3
"""Read-only exact subject scan for VEVO batch 54 candidates."""
...
OUT = ROOT / "content/VEVO_CONTENT/exports/batch-54-admin-candidate-scan-2026-08-28.json"
...
SUBJECTS = {
    "buckram": ["buckram", "buckram cloth"],
    "madras": ["madras", "madras cloth"],
    "santan": ["santan", "shantung"],
    "challis": ["challis"],
    "biliardove sukno": ["biliardove sukno", "baize", "billiard cloth"],
    "pepito": ["pepito", "houndstooth", "kohutia stopa"],
    "glencek": ["glencek", "glen check", "glen plaid", "prince of wales"],
    "barchet": ["barchet", "flannelette"],
    "fustian": ["fustian"],
    "barkcloth": ["barkcloth", "bark cloth"],
    "konske sukno": ["konske sukno", "horsehair cloth", "haircloth"],
    "sharkskin": ["sharkskin", "sharkskin cloth"],
    "cavalry twill": ["cavalry twill", "cavalry weave"],
