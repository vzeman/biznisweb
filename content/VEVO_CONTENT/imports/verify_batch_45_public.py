#!/usr/bin/env python3
"""Independently verify VEVO batch 45 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-45-2026-08-23-articles.json")
OUT_JSON = Path(
    "content/VEVO_CONTENT/exports/batch-45-2026-08-23-publication-verify.json"
)
USER_AGENT = "Codex VEVO batch 45 independent public verification"
...
def main() -> None:
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 45 public verification failed")
