#!/usr/bin/env python3
"""Independently verify VEVO batch 51 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-51-2026-08-27-articles.json")
OUT_JSON = Path(
    "content/VEVO_CONTENT/exports/batch-51-2026-08-27-publication-verify.json"
)
...
def main() -> None:
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 51 public verification failed")
