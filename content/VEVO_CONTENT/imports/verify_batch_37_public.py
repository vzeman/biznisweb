...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-37-2026-07-14-articles.json")
OUT_JSON = Path("content/VEVO_CONTENT/exports/batch-37-2026-07-14-publication-verify.json")
USER_AGENT = "Codex VEVO batch 37 public verification"
...
def main():
    ...
    if not output["all_ok"]:
        raise SystemExit("Batch 37 public verification failed")
