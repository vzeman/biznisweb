#!/usr/bin/env python3
"""Independently verify VEVO batch 55 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-55-2026-08-28-articles.json")
OUT_JSON = Path(
    "content/VEVO_CONTENT/exports/batch-55-2026-08-28-publication-verify.json"
)
MIN_VISIBLE_WORDS = 3000
...
def main() -> None:
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 55 public verification failed")
