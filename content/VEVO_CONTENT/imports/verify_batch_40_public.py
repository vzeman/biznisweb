...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-40-2026-07-16-articles.json")
OUT_JSON = Path("content/VEVO_CONTENT/exports/batch-40-2026-07-16-publication-verify.json")
USER_AGENT = "Codex VEVO batch 40 public verification"
...
def article_segment(page_source):
    ...
    end = min(ends) if ends else min(len(page_source), start + 220_000)
...
def main():
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 40 public verification failed")
