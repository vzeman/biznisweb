#!/usr/bin/env python3
"""Independently verify VEVO batch 46 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-46-2026-08-24-articles.json")
OUT_JSON = Path("content/VEVO_CONTENT/exports/batch-46-2026-08-24-publication-verify.json")
...
def main() -> None:
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 46 public verification failed")
