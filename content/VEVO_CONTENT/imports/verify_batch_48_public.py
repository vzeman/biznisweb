#!/usr/bin/env python3
"""Independently verify VEVO batch 48 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-48-2026-08-25-articles.json")
OUT_JSON = Path("content/VEVO_CONTENT/exports/batch-48-2026-08-25-publication-verify.json")
...
def main() -> None:
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 48 public verification failed")
