#!/usr/bin/env python3
"""Independently verify VEVO batch 54 on the public website."""
...
ARTICLES_JSON = Path("content/VEVO_CONTENT/imports/batch-54-2026-08-28-articles.json")
OUT_JSON = Path(
    "content/VEVO_CONTENT/exports/batch-54-2026-08-28-publication-verify.json"
)
MIN_VISIBLE_WORDS = 2800
...
def main() -> None:
    ...
    for result in results:
        result["minimum_visible_words"] = MIN_VISIBLE_WORDS
        result["ok"] = bool(result["ok"]) and (
            int(result["visible_word_count"]) >= MIN_VISIBLE_WORDS
        )
    ...
    if not output["all_ok"]:
        ...
        raise SystemExit("Batch 54 public verification failed")
