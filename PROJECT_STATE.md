...
- VEVO GrowthBook Production clone is verified complete and still hard-disabled for traffic (`2026-08-23`):
  ...
  - Next exact step: merge the schema-`6` consent hard gate, set and read back consent metadata only on GTM tags `54`, `51`, `55`, and `53`, repeat Preview consent QA, record the verified read-back through Git, and only then reopen GTM publishing while GrowthBook remains Draft
