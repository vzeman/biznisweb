...
def generate_html_report(date_agg: pd.DataFrame, date_product_agg: pd.DataFrame,
                         ...
                         ltv_by_date: pd.DataFrame = None) -> str:
    """
...
<body>
    ...
    if financial_metrics:
        ...
        profit_margin = financial_metrics.get('profit_margin_pct', 0)
        html_content += f"""
            <div class="card">
            ...
            <div class="card">
                <div class="card-title">Revenue/Customer</div>
                <div class="card-value">€{revenue_per_customer:.2f}</div>
            </div>
            <div class="card">
                <div class="card-title">Profit Margin</div>
                <div class="card-value {'profit' if profit_margin > 0 else 'cost'}">{profit_margin:.1f}%</div>
            </div>"""
    ...
    if cost_per_order:
        ...
        <div class="summary-cards">
            ...
            <div class="card">
                <div class="card-title">Overall ROAS</div>
    ...
    if cohort_analysis is not None:
        ...
        <div class="table-container" style="background: linear-gradient(135deg, #10B981 0%, #059669 100%); margin-top: 30px;">
            ...
            <p style="color: white; padding: 0 15px 15px; font-size: 0.9rem;">
                ℹ️ <strong>Poznámka:</strong> Tieto čísla sú presnejšie, pretože zahŕňajú len kohorty, ktoré mali dosť času (90+ dní) na opätovný nákup.
    ...
    if time_to_nth_by_first_item is not None:
        ...
        <p style="text-align: center; color: white; margin-bottom: 20px; opacity: 0.8;">Porovnanie priemerného času (v dňoch) do 2., 3., 4. objednávky podľa toho, aký produkt mali v prvej objednávke</p>
    ...
    if ads_effectiveness:
        ...
        <div class="chart-grid">
            <div class="chart-container">
                ...
                <p class="chart-explanation">Scatter plot showing relationship between daily total costs (product + ads + fixed) and revenue. Higher correlation indicates predictable cost-revenue relationship.</p>
...
"""
        ...
        segment_configs = {
            ...
            'second_order_encouragement': {'color': '#8B5CF6', 'icon': '2️⃣', 'priority': 2},
...
"""
        ...
        <div class="table-container" style="background: #f0fdf4; border-left: 4px solid #10B981;">
            <h2 class="table-title">📊 Súhrn segmentácie</h2>
...
🎁 ZĽAVA 10% na Vašu druhú objednávku
Kód: DRUHAOBJ

Čo si obľúbili naši zákazníci:
✓ Intenzívna a dlhotrvajúca vôňa
...
Nechceme, aby Vaša bielizeň stratila svoju obľúbenú vôňu! 🌸

🚚 DOPRAVA ZADARMO pri objednávke nad 25€
(Platí len tento týždeň)
...
Tím Vevo''',
        ...
        'vip_customers': {
            ...
            'priority': 4,
            'subject': '👑 Exkluzívne pre VIP: Nová vôňa ešte pred ostatnými!',
            'body': '''Dobrý deň {meno},
...
P.S. Máte nápad na novú vôňu? Napíšte nám, radi vypočujeme! 💬''',
...
Nechceme, aby Vám ušla príležitosť mať voňavú bielizeň! 🌸
...
🎁 Ako ospravedlnenie za nepríjemnosti máme pre Vás:
...
P.S. Vaše produkty sú stále v košíku a čakajú na Vás! 🛒''',
        ...
        'long_dormant': {
            ...
            'priority': 5,
            'subject': 'Už ste zabudli na voňavú bielizeň? 😢 Máme pre Vás prekvapenie',
            'body': '''Dobrý deň {meno},
...
dúfame, že si užívate voňavú bielizeň s našimi parfumami! 🌸
...
• Tipy na starostlivosť o bielizeň
